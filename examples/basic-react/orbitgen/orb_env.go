...
var wrapDocRender = map[PageRender]*DocumentRenderer{
	ExampleTwoPage: {fn: []RenderFunction{reactSSR,reactHydrate}, version: []string{"reactSSR,reactHydrate"}},
	ExamplePage: {fn: []RenderFunction{reactSSR,reactHydrate}, version: []string{"reactSSR,reactHydrate"}},
}
...
var pageDependencies = map[PageRender][]string{
	ExampleTwoPage: []string{`<script src="/p/fc38086145547d465be97fec2e412a16.js"></script>`,
`<script src="/p/a63649d90703a7b09f22aed8d310be5b.js"></script>`,
},
	ExamplePage: []string{`<script src="/p/fc38086145547d465be97fec2e412a16.js"></script>`,
`<script src="/p/a63649d90703a7b09f22aed8d310be5b.js"></script>`,
},
}
